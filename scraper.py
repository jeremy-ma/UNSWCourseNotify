...
def insertList(l):
    ...
    try:
        for section in l:
            ...
            query=("INSERT INTO sections (course_code,course_name, section_code, sem, type, enr_max, enr_count, status) VALUES(%s, %s, %s, %s, %s, %s, %s, %s) ON DUPLICATE KEY UPDATE id=LAST_INSERT_ID(id);")
