    ...
    try:
        for section in l:
            ...
            cursor.execute(query,(
                section['course_code'], section['course_name'],section['id'], section['semester'],section['type'],section['enr_max'],section['enr_count'],section['status'],section['section_time']
                ))
